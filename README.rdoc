...
What's does it mean when we say that someone or something is '2'?
...
* Add the 'rerum' gem as a dependency in your environment.rb (Rails 2.3.x) or Gemfile (if you're using Bundler)
